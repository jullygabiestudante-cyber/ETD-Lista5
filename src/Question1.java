...
public class Question1 {
    ...
    public static void main(String[] args) {
        ...
        numero = sc.nextInt();
        System.out.println("Digite a posição do numero que deseja alocar : ");
        posicao = sc.nextInt();

        calculo(posicao, numero, vetor, tam);
    ...
    public static void calculo(int posicao, int numero, int[] vetor, int tam) {
        int i;
